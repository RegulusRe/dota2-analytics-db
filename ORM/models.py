...
class Tournaments(Base):
    ...
    tournament_id = Column(Integer, primary_key=True, autoincrement=True, index=True)
...
class Teams(Base):
    __tablename__ = "Teams"
    team_id = Column(Integer, primary_key=True, autoincrement=True, index=True)
...
class Heroes(Base):
    ...
    hero_id = Column(Integer, primary_key=True, autoincrement=True, index=True)
    name = Column(String(255), unique=True, nullable=False)
...
class Series(Base):
    ...
    series_id = Column(Integer, primary_key=True, autoincrement=True, index=True)
...
class Matches(Base):
    ...
    match_id = Column(Integer, primary_key=True, autoincrement=True, index=True)
    series_id = Column(Integer, ForeignKey("Series.series_id"))
    tournament_id = Column(Integer, ForeignKey("Tournaments.tournament_id"))
    team_radiant = Column(Integer, ForeignKey("Teams.team_id"))
    team_dire = Column(Integer, ForeignKey("Teams.team_id"))
    winner_id = Column(Integer, ForeignKey("Teams.team_id"))

class Statistics(Base):
    __tablename__ = "Statistics"
    stat_id = Column(Integer, primary_key=True, autoincrement=True, index=True)
...
class Prizes(Base):
    ...
    prize_id = Column(Integer, primary_key=True, autoincrement=True, index=True)
    tournament_id = Column(Integer, ForeignKey("Tournaments.tournament_id"))
    team_id = Column(Integer, ForeignKey("Teams.team_id"))
